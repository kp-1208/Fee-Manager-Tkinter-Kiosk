...
def update_data():
    ...
    trans_fee_a = transfee_a_entry.get() 
    trans_fee = transfee_entry.get()
    stationeryfee_a = stationeryfee_a_entry.get()
    stationery_fee = stationeryfee_entry.get()
    paid_balance = balance_entry.get()
    if not tut_fee:
        tut_fee = 0
    if not trans_fee:
        trans_fee = 0
    ...
    transaction_balance = (float(trans_fee_a) - 
                           float(trans_fee)) + (float(stationeryfee_a) - 
                                                float(stationery_fee)) - float(paid_balance) 

    added_values = { 'balance':float(transaction_balance)}
    updated_values = {'tution_fee_p':float(tut_fee), 'ID':id, 'trans_fee_p':float(trans_fee), 'stationery_fee_p':float(stationery_fee), 
                      'trans_fee_a':trans_fee_a, 'stationery_fee_a':stationeryfee_a,
...
def add_data():
    ...
    added_values = {'ID':id, 'fname':fname, 'mname':mname, 'lname':lname, 'f_fname':f_fname,
                    ...
                    'tution_fee_a':TUT_FEE, 'trans_fee_a':0, 'stationery_fee_a':0,
...
transfee_a_label = tk.Label(update_page, bg="#00465e", fg="white", text="Enter Transport Fee Applicable:")
transfee_a_entry = tk.Entry(update_page, bg="#0c343d", fg="white", font=("ARIAL",12))
...
stationeryfee_a_label = tk.Label(update_page, bg="#00465e", fg="white", text="Enter Stationery Fee Applicable:")
stationeryfee_a_entry = tk.Entry(update_page, bg="#0c343d", fg="white", font=("ARIAL",12))
...
balance_label = tk.Label(update_page, bg="#00465e", fg="white", text="Enter Balance Paid:")
balance_entry = tk.Entry(update_page, bg="#0c343d", fg="white", font=("ARIAL",12))
...
transfee_a_label.config(bg="#00465e", fg="white", font=("Arial", 12))
stationeryfee_a_label.config(bg="#00465e", fg="white", font=("Arial", 12))
stationeryfee_label.config(bg="#00465e", fg="white", font=("Arial", 12))
balance_label.config(bg="#00465e", fg="white", font=("Arial", 12))
...
transfee_a_label.grid(row=3, column=0, padx=5, pady=5)
transfee_a_entry.grid(row=3, column=1, padx=5, pady=5)
transfee_label.grid(row=4, column=0, padx=5, pady=5)
transfee_entry.grid(row=4, column=1, padx=5, pady=5)
stationeryfee_a_label.grid(row=5, column=0, padx=5, pady=5)
stationeryfee_a_entry.grid(row=5, column=1, padx=5, pady=5)
stationeryfee_label.grid(row=6, column=0, padx=5, pady=5)
stationeryfee_entry.grid(row=6, column=1, padx=5, pady=5)
balance_label.grid(row=7, column=0, padx=5, pady=5)
balance_entry.grid(row=7, column=1, padx=5, pady=5)
update_button.grid(row=8, column=0, columnspan=2, padx=5, pady=40)
report_button_update.grid(row=9, column=0, columnspan=2, padx=5, pady=40)
back_button_update.grid(row=10, column=0, columnspan=2, padx=5, pady=100)
